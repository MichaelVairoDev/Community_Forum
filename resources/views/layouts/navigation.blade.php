<nav x-data="{ open: false }" class="bg-indigo-600 border-b border-indigo-500">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                    <x-nav-link :href="route('threads.create')" :active="request()->routeIs('threads.create')" class="text-white">
                        {{ __('Nuevo Tema') }}
                    </x-nav-link>
                    @endauth
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="text-white hover:text-gray-200 font-bold">Registrarse</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
            <x-responsive-nav-link :href="route('threads.create')" :active="request()->routeIs('threads.create')" class="text-white">
                {{ __('Nuevo Tema') }}
            </x-responsive-nav-link>
            @endauth
        </div>
